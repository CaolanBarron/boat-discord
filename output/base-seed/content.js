export const prompts = [
    {
        ...
        actions: [
            ...
            },
            {
                ...
                outcomes: [
                    {
                        content: 'Perhaps a the unique biological makeup of this strange algae could be used to enhance the engine...',
                        outcomeType: 'SUCCESS',
                        effectId: 1,
                    },
                    {
    ...
    },
    {
        ...
        actions: [
            ...
            },
            {
                ...
                outcomes: [
                    {
                        content: 'The privacy is respectful, When you turn around she is gone...',
                        outcomeType: 'SUCCESS',
                        effectId: null,
                    },
                ],
        ...
        actions: [
            {
                ...
                outcomes: [
                    {
                        content: 'A flash of light and a warm feeling... Some just need to be guided to a material place',
                        outcomeType: 'SUCCESS',
                        effectId: 6,
                    },
                ],
            },
            {
                ...
                outcomes: [
                    {
                        content: 'A dark shadow descends over The Boat... Ignoring problems is not always wise...',
                        outcomeType: 'FAILURE',
                        effectId: 7,
                    },
                ],
